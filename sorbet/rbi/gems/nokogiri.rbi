...
class Nokogiri::XML::SAX::Parser::Attribute < Anonymous_Struct_49
end
...
class Nokogiri::XML::Notation < Anonymous_Struct_50
end
...
class Nokogiri::HTML::EntityDescription < Anonymous_Struct_51
end
